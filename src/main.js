...
function showNotificationPopup(notification) {
  ...
  if (notification.type === "CONFIRMED" || notification.status === "CONFIRMED") {
    ...
    `;
  } else if (notification.type === "CHECKED_IN" || notification.status === "CHECKED_IN") {
    ...
    `;
  } else if (notification.type === "CANCELLED" || notification.status === "CANCELLED") {
    ...
    `;
  } else if (notification.type === "REMINDER" || notification.status === "REMINDER") {
